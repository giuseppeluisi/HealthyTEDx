...
##### FROM FILES
tedx_dataset_path = "s3://tedx-prova-2024/final_list.csv"
...
## READ THE DETAILS
details_dataset_path = "s3://tedx-prova-2024/details.csv"
...
images_dataset_path = "s3://tedx-prova-2024/images.csv"
...
write_mongo_options = {
    ...
    "collection": "tedx_data_2_1",
    "ssl": "true",
    "ssl.domain_match": "false"}
from awsglue.dynamicframe import DynamicFrame
tedx_dataset_dynamic_frame = DynamicFrame.fromDF(tedx_dataset_filtered, glueContext, "nested")
